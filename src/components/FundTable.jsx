                ...
                <table className="w-full text-left border-collapse">
                    <thead>
                        <tr className="bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 text-sm uppercase">
                            <th className="p-3 border-b dark:border-gray-600">Asset Name (Cash/Bank)</th>
                            <th className="p-3 border-b dark:border-gray-600 w-40">Current Amount</th>
                            <th className="p-3 border-b dark:border-gray-600 w-10"></th>
                        </tr>
                    </thead>
                    <tbody>
                        {funds.map((fund) => (
                            <tr key={fund.id} className="border-b hover:bg-gray-50 dark:hover:bg-gray-700 dark:border-gray-600 transition">
                                <td className="p-3">
                                    <input
                                        type="text"
                                        value={fund.name}
                                ...
                                <td className="p-3 text-right">
                                    <button onClick={() => removeFund(fund.id)} className="text-gray-400 hover:text-red-500 dark:text-gray-500 hover:bg-red-50 p-2 rounded transition">
                                        <Trash2 size={16} />
                                    </button>
                                </td>
                            </tr>
